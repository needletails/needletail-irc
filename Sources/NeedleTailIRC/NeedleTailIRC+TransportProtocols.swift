...
public protocol NeedleTailWriterDelegate: AnyObject, Sendable {
    ...
    /// Transports a message using the provided parameters.
    ///
    /// - Parameters:
    ...
    ///   - origin: A `String` representing the origin of the message.
    ///   - command: An instance of `IRCCommand` representing the command associated with the message.
    ///   - tags: An optional array of `IRCTag` representing any tags associated with the message.
    ///   - authPacket: An optional `AuthPacket` for authentication information.
    /// - Throws: An error if the message transport fails.
