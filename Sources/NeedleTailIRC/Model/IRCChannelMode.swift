...
public struct IRCChannelMode: Codable, OptionSet, Sendable, Hashable {
    ...
    public static let channelOperatorAdmin = IRCChannelMode(rawValue: 1 << 0)
    /*
     ...
     */
    public static let channelOperator = IRCChannelMode(rawValue: 1 << 1)
    /*
     ...
     */
    public static let `private` = IRCChannelMode(rawValue: 1 << 2)
    /*
     ...
     */
    public static let secret = IRCChannelMode(rawValue: 1 << 3)
    /*
     ...
     */
    public static let inviteOnly = IRCChannelMode(rawValue: 1 << 4)
    /*
     ...
     */
    public static let topicOnlyByOperator = IRCChannelMode(rawValue: 1 << 5)
    /*
     ...
     */
    public static let noOutsideClients = IRCChannelMode(rawValue: 1 << 6)
    /*
     ...
     */
    public static let moderated = IRCChannelMode(rawValue: 1 << 7)
    /*
     ...
     */
    public static let userLimit = IRCChannelMode(rawValue: 1 << 8)
    /*
     ...
     */
    public static let banMask = IRCChannelMode(rawValue: 1 << 9)
    /*
     ...
     */
    public static let speakControl = IRCChannelMode(rawValue: 1 << 10)
    /*
     ...
     */
    public static let password = IRCChannelMode(rawValue: 1 << 11)
    ...
    public init?(_ string: String) {
        ...
        for c in string {
            switch c {
            case "O": mask += IRCChannelMode.channelOperatorAdmin.rawValue
