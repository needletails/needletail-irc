...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/needle-tail/needletail-logger.git", .upToNextMajor(from: "1.0.3")),
//        .package(url: "https://github.com/needle-tail/needletail-algorithms.git", .upToNextMajor(from: "1.0.9")),
        .package(path: "../needletail-algorithms"),
//        .package(url: "git@github.com:needle-tail/needletail-structures.git", .upToNextMajor(from: "1.0.4")),
        .package(path: "../needletail-structures"),
